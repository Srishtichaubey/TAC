...
<span class="pull-right top title1" ><span class="log1"><a href="home.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span></div>
</div><div class="row">
<div class="col-lg-3">
<span class="logo"><a href="food.php" style="text-decoration:none;font-size: 20px; font-family: arial; float:left; margin-left:100px; margin-top:20px; color:orange;">Search</a></span></div>
<div class="col-lg-3">
<span class="logo"><a href="foodad.php" style="text-decoration:none; float:left;font-size: 20px; margin-left:100px; margin-top:20px; color:orange;">Publish Ad</a></span></div>
</div></div>
...
<div class="col-sm-5 mute" style=" margin-left:0px;background-color:white;height:600px;float:left;font-family:arial;opacity:0.7;font-size:20px;">
<center><form action="foodsphp.php" method="post" enctype="multipart/form-data"><br>
<h1>Fooding by TAF<hr></b></h1><br><br>
