  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      ...
      <div class="modal-body">
        <form class="form-horizontal" action="database4.php" method="POST">
<fieldset>
...
<!-- sign in form begins -->  
  <form class="form-horizontal" name="form" action="database5.php" onSubmit="return validateForm()" method="POST"><fieldset>  
  <div class="form-group">
