...
if(isset($_POST['submitted'])) {
	...
	$query = "SELECT * FROM acco WHERE $category LIKE '%" .$critaria."%'";
	...
	echo "<tr> 
	<th style='border:1px solid black;background:#8b9eb6;font-color:red; cellspacing:20px; cellspadding:20px;margin-left:20px;'>Id</th>
	<th style='border:1px solid black;background:#8b9eb6;font-color:red;'>Location</th>
  <th style='border:1px solid black;background:#8b9eb6;font-color:red;'>Rooms</th>
    <th style='border:1px solid black;background:#8b9eb6;font-color:red;'>Rent</th>
  <th style='border:1px solid black;background:#8b9eb6;font-color:red;'>image</th>";
