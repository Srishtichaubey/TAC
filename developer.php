...
<div class="col-lg-6">
<span class="logo"><a href="home.php" style="text-decoration:none; margin-left:10px; margin-top:20px; color:orange;">TAF</a></span></div>
<div class="col-md-2">
</div>


<a href="landing.html" class="pull-right btn sub1 title3"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Home</a>&nbsp;
</div></div>


<!--header end-->
<div class="bg" style="background: #083648;">
<div class="row">
<div class="col-sm-12">
<h2 style="color:orange;"><center><b><u>THE CODER</u><b></center></h2>
</div>
</div>
  <div class="bg1">
<div class="row">
  <div class="back_ground_blur" style="margin-top: -50px; background-color: rgb(219, 219, 219);  opacity:0.9;"> </div>
  <div class="container" style="padding-bottom: 50px;">
   <!--first row-->
    <div class="row" style="margin-top:20px;">
      ...
      <div class="container col-md-4" style="align-items: center; margin-left: 190px; margin-top: 50px;">
        <img class="profile_photo profile_photo2" src="sheu.jpg" onmouseover="hover2(this);" onmouseout="unhover2(this);" >
        <h1 style="text-align: center;color:yellow; font-size:20px;">SRISHTI CHAUBEY<br> CS SECOND YEAR <br>(Developer and coder)</h1>
      </div>
    </div> 
    </div>
  </div>
    ...
    <div class="modal-content" style="background:#000 url(pic/bg1.jpg)">
      ...
      <div class="modal-body">
		...
		<div class="col-md-3">
		 ...
		 <div class="col-md-9">
	<h4 style="font-family:'italian'; text-align:'right'; ">TAF is a tool to help you find the best services available in Tirwa. </h4>
	</div></div>
		</p>
      </div>
