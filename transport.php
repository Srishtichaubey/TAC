...
<div class="row">
<div class="col-lg-3">
<span class="logo"><a href="new.php" style="text-decoration:none;font-size: 20px; font-family: arial; float:left; margin-left:100px; margin-top:20px; color:orange;">Search</a></span></div>
...
<center>
    <form action="transphp.php" method="post"><br>
