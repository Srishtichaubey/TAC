...
<h1><b><center>Here's your drive!!</center></b></h1><hr>
<?php
    $sloc=$_POST["loc"];
    $sdes=$_POST["des"];
...
$q="select* from transport where loc='$sloc' && des='$sdes'";
$result= mysqli_query($con,$q);
$num=mysqli_num_rows($result);
if($num==1)
{
}
echo "<table border='2' style='width:80%;height:auto; text-align:center;margin-left:20px;'>";
    echo "<tr> 
    <th style='borer:1px solid black;background:#8b9eb6; font-color:red; cellspacing:2px; cellspadding:2px;'>Id</th>
