...
<div class="col-sm-6 mute" style=" margin-left:-80px; background-color:white; height:600px;float:left;font-family:arial; opacity:0.7; font-size:20px;">
 <form class="form-horizontal" name="form" action="accdb.php" onSubmit="return validateForm()" method="POST" style="margin-left: 20px;"><fieldset>  
<h1><b><center>Advertise your rooms!!</center></b></h1><br><br>
<div class="form-group">
    <label for="exampleInputEmail1">Location</label>
    <input type="text" class="form-control" id="exampleInputEmail1" name="location" placeholder="Enter the Location">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Rooms</label>
    <input type="number" class="form-control" id="exampleInputEmail1" name="room" placeholder="Enter the Rooms available">
  </div>
 <div class="form-group">
    <label for="exampleInputEmail1">Contact Info</label>
    <input type="number" class="form-control" id="exampleInputEmail1" name="contact"  placeholder="Enter your contact number">
  </div> 

 <div class="form-group">
    <label for="exampleInputEmail1">Rent</label>
    <input type="number" class="form-control" id="exampleInputEmail1" name="rent"  placeholder="Enter the rent">
  </div> 
   <div class="form-group">
    <label for="exampleInputEmail1">Image</label>
    <input type="file" class="form-control" id="exampleInputEmail1" name="image"  placeholder="Enter an image">
  </div> 
 <div class="form-group">
