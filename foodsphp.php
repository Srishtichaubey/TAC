...
<div class="col-sm-2" style="float:left;"></div><center>
...
if(isset($_POST['submitted'])) {
	...
	$query = "SELECT * FROM food WHERE $category LIKE '%" .$critaria."%'";
	...
	echo "<tr> 
	<th style='border:1px solid black;background:#8b9eb6;font-color:red;'>Id</th>
	<th style='border:1px solid black;background:#8b9eb6;font-color:red;'>Resturant</th>
	<th style='border:1px solid black;background:#8b9eb6;font-color:red;'>Dish</th>
    <th style='border:1px solid black;background:#8b9eb6;font-color:red;'>Price</th>
	<th style='border:1px solid black;background:#8b9eb6;font-color:red;'>Review</th>";
