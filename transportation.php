...
<div class="row">
<div class="col-lg-3">
<span class="logo"><a href="transportation.php" style="text-decoration:none;font-size: 20px; font-family: arial; float:left; margin-left:100px; margin-top:20px; color:orange;">Search</a></span></div>
<div class="col-lg-3">
<span class="logo"><a href="transfer.php" style="text-decoration:none; float:left;font-size: 20px; margin-left:100px; margin-top:20px; color:orange;">Publish Ad</a></span></div>
</div>
</div>
...
<center>
<form action="last.php" method="post"><br>
<h1><b>Transport by TAF</b></h1><br><br>
...
<option value= "gandhi chauraha">Gandhi Chauraha</option>
</select><br><br>
